...
QT_MOC_LITERAL(1, 5, 6), // "sendAU"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 2), // "au"
QT_MOC_LITERAL(4, 16, 3) // "run"

    },
    "Test\0sendAU\0\0au\0run"
};
...
void Test::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendAU((*reinterpret_cast< void*(*)>(_a[1]))); break;
        case 1: _t->run(); break;
        default: ;
        }
        ...
        {
            using _t = void (Test::*)(void * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Test::sendAU)) {
                *result = 0;
                return;
            }
        }

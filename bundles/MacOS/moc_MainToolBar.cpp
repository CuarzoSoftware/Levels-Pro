...
#include <memory>
#include "../../code/src/UI/MainWindow/MainToolBar.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MainToolBar_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject MainToolBar::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_MainToolBar.data,

...
#include <memory>
#include "../../code/src/Audio/TimeSettings.h"
...
QT_MOC_LITERAL(1, 13, 20), // "projectLengthChanged"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "TimeSettings\0projectLengthChanged\0"
};
...
void TimeSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->projectLengthChanged(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeSettings::projectLengthChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TimeSettings::staticMetaObject = { {
    ...
    qt_meta_stringdata_TimeSettings.data,
    qt_meta_data_TimeSettings,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void TimeSettings::projectLengthChanged()
{

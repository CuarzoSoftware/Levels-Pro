/****************************************************************************
** Meta object code from reading C++ file 'MediaMenu.h'
**
...
#include <memory>
#include "../../code/src/UI/Media/MediaMenu.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'MediaMenu.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MediaMenu_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MediaMenu_t qt_meta_stringdata_MediaMenu = {
    {
QT_MOC_LITERAL(0, 0, 9) // "MediaMenu"
...
QT_INIT_METAOBJECT const QMetaObject MediaMenu::staticMetaObject = { {
    QMetaObject::SuperData::link<MainMenu::staticMetaObject>(),
    qt_meta_stringdata_MediaMenu.data,

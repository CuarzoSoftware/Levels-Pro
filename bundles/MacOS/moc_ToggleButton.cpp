...
#include <memory>
#include "../../code/src/Widgets/ToggleButton.h"
...
QT_MOC_LITERAL(3, 22, 5) // "state"
    ...
    "ToggleButton\0changed\0\0state"
};
...
void ToggleButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ToggleButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ToggleButton::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ToggleButton::changed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ToggleButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_ToggleButton.data,
    qt_meta_data_ToggleButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ToggleButton::changed(bool _t1)
{
